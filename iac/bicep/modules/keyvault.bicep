...
resource keyvault 'Microsoft.KeyVault/vaults@2023-07-01' ={
  ...
  properties:{
    ...
    accessPolicies:[
      { tenantId: subscription().tenantId
        objectId: 'aebc135d-a0b7-4be4-9051-01b0ef24e4d0' // Replace this with your user/group ObjectID
        permissions: {secrets:['list','get','set']}
      }
      { tenantId: subscription().tenantId
        objectId: '69b4a015-a918-4170-9de8-8475b0a0de9c' // Replace this with your user/group ObjectID
